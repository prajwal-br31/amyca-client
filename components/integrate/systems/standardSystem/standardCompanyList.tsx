...
const techItems = [
  ...
  { id: 4, name: "Standard Application-1", logo: workday },
  { id: 5, name: "Standard Application-2", logo: workday },
  { id: 6, name: "Standard Application-3", logo: workday },
  { id: 7, name: "Standard Application-4", logo: workday },
  { id: 8, name: "Standard Application-5", logo: workday },
];

export function StandardCompanyDetails({
  open,
  onClose,
}: {
  open: boolean;
